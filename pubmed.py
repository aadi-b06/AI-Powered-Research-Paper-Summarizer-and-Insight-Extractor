...
pubmed.py
---------
Data Ingestion Layer for PubMed papers.
Fetches papers via NCBI eUtils API, extracts structured insights,
and saves results to 'pubmed_multiple_queries.json'.
"""
...
file_name = "pubmed_multiple_queries.json"
all_papers = []
seen_pmids = set()
        ...
        try:
            ...
            for article in root.findall(".//PubmedArticle"):
                try:
                    ...
                    print(f"  → Extracting insights for PMID {pmid}...")
                    data = {
                        "query": query,
                        "pmid": pmid,
